...
contract lottery {
    ...
    function revealChoice(uint choice, uint salt) public {
        require(startTime == 0 || block.timestamp - startTime >= T1, "Too early");
    ...
    function checkWinner() public payable {
        require(startTime == 0 || block.timestamp - startTime - T1 <= T2, "Too early");
    ...
    function withdraw() public payable {
        require(startTime == 0 || startTime != 0 && block.timestamp >= startTime + T1 + T2, "Please wait");
